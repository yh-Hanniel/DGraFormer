...
device_count2 = torch.cuda.device_count()
print(device_count2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='DGraFormer',
    ...
    parser.add_argument('--pct_start', type=float, default=0.3, help='pct_start')  # 学习率从初始值增加到最大值所需的训练周期比例
